...
int tutorial_3( const std::string file_name, const char * config )
{
	...
	Raytracer raytracer( 1920, 1080, deg2rad(42.185f), Vector3(-140.0f, -175.0f, 110.0f), Vector3(0.0f, 0.0f, 40.0f), config );
	//Raytracer raytracer(1280, 720, deg2rad(42.185f), Vector3(5.0f, 0.0f, 0.0f), Vector3(0.0f, 0.0f, 0.0f), config);

	//Raytracer raytracer(320, 240, deg2rad(40.0), Vector3(40, -940, 250), Vector3(0, 0, 250), config);
	//Raytracer raytracer(320, 240, deg2rad(40.0), Vector3(5.0f, 0.0f, 0.0f), Vector3(0.0f, 0.0f, 0.0f), config);
	//Raytracer raytracer(320, 240, deg2rad(40.0), Vector3(0, 0, 20), Vector3(0, 250, 0), config);
